...
class NeatAlgorithmTest {
    ...
    fun `mutate add node to model`() {
        ...
        val nodeId = 6
        val experiment = simpleNeatExperiment(random, innovation, nodeId, activationFunctions, 0)
        val expectedSize = 1
    ...
    fun `crossover two equal genomes take no excess`() {
        ...
        val (parent1, parent2) = createTwoRelatedGenomes(random)
        val neatExperiment = simpleNeatExperiment(random, 11, 7, activationFunctions, 0)
    ...
    fun `crossover parent 1 more fit than parent 2 genomes`() {
        ...
        val expectedConnectionGenes = (expectedMatchingGenes + excess(parent1, parent2) + disjoint(
            parent1,
            parent2
    ...
    fun `excess genes between two genomes`() {
        ...
        assertEquals(expectedExcess, excess)
    }
