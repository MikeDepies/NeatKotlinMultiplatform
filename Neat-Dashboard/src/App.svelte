<script>
	...
	let parameters: XorParametersUI = {
		activationFunctions: [],
		generations: 10,
		mateChance: 0.4,
		mutations: [],
	...
	let { write, read } = wsListen<StartExperimentRoute & RegisterSessionRoute & InitialPopulationRoute>()
	...
	$: console.log(`initial population: ${$initialPopulation?.length}`)
	...
	type ActivationFunctionParameter = {
		name: string;
	};
							...
							<div class="shadow overflow-hidden sm:rounded-md">
                                ...
                                transition duration-150 ease-in-out" />
															...
															<div class="ml-3 text-sm leading-5 flex-grow ">
																...
																<p
																	class="text-gray-500 group-hover:bg-gray-100">
